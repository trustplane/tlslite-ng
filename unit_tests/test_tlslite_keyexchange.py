...
class TestECDHE_RSAKeyExchange_with_x25519(unittest.TestCase):
    def setUp(self):
        ...
        self.srv_pub_key = srv_chain.getEndEntityPublicKey()
        self.cipher_suite = CipherSuite.TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA
        ext = [SupportedGroupsExtension().create([GroupName.ecdh_x25519])]
        self.client_hello = ClientHello().create((3, 3),
                                                 bytearray(32),
                                                 bytearray(0),
                                                 [],
    ...
    def test_ECDHE_key_exchange(self):
        ...
        self.assertEqual(srv_key_ex.named_curve, GroupName.ecdh_x25519)
...
class TestECDHE_RSAKeyExchange_with_x448(unittest.TestCase):
    def setUp(self):
        ...
        self.srv_pub_key = srv_chain.getEndEntityPublicKey()
        self.cipher_suite = CipherSuite.TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA
        ext = [SupportedGroupsExtension().create([GroupName.ecdh_x448])]
        self.client_hello = ClientHello().create((3, 3),
                                                 bytearray(32),
                                                 bytearray(0),
                                                 [],
    ...
    def test_ECDHE_key_exchange(self):
        ...
        self.assertEqual(srv_key_ex.named_curve, GroupName.ecdh_x448)
